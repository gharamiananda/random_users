...
const { randomNumber } = require('../middleware/randomGenerateNumber');
let userdata = require('../userdata.json');

module.exports.getRandomUser = (req, res, next) => {
    const num = randomNumber(0, userdata.length - 1);
    const randomUser = userdata[num]
    console.log(num, randomUser)
    res.json(randomUser)
}
